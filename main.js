...
function cambiarEscena_2_3(){
    ...
    belmonte.style.animation="arribaNormal 5s "
    efecto.play();
}
function cambiarEscena_3_4(){
    belmonte.style.display="none";
   sisante.style.display="block";
   sisante.style.animation="izquierdaNormal 5s "
   efecto.play();
...
function cambiarEscena_4_5(){
    ...
    sanclemente.style.animation="arribaNormal 5s "
    efecto.play();
}
function cambiarEscena_5_6(){
    sanclemente.style.display="none";
    huete.style.display="block";
    huete.style.animation="izquierdaNormal 5s "
    efecto.play();
}
...
function reproducirMusica(){
   if(audio.paused){
    audio.play();
    icono.className="bi bi-pause-cicle";

}else{
    audio.pause();
    icono.className="bi bi-play-cicle";
}
}